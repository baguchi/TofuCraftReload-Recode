...
public class TofuStemCacheBlock extends HorizontalBlock {
	...
	public TofuStemCacheBlock(Properties builder) {
		super(builder);
		func_180632_j((BlockState) ((BlockState) this.field_176227_L.func_177621_b()).func_206870_a((Property) ZUNDAMA, Boolean.valueOf(true)));
	}

	public ActionResultType func_225533_a_(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
		boolean hasZunda = ((Boolean) state.func_177229_b((Property) ZUNDAMA)).booleanValue();
		if (hasZunda) {
			ItemStack salt = new ItemStack((IItemProvider) TofuItems.ZUNDAMA, 1);
			...
			worldIn.func_180501_a(pos, (BlockState) state.func_206870_a((Property) ZUNDAMA, Boolean.valueOf(false)), 3);
	...
	protected void func_206840_a(StateContainer.Builder<Block, BlockState> builder) {
		builder.func_206894_a(new Property[]{(Property) HorizontalBlock.field_185512_D, (Property) ZUNDAMA});
	}
}
