...
public class TofuRecipeCategories {
	...
	public static void registerRecipeCategories(RegisterRecipeBookCategoriesEvent event) {
		...
		event.registerBookCategories(TofuRecipeBookTypes.COOKING, ImmutableList.of(COOKING_SEARCH.get(), COOKING_MEALS.get(), COOKING_FAST_FOOD.get(), COOKING_DRINKS.get(), COOKING_MISC.get()));
		...
		event.registerBookCategories(TofuRecipeBookTypes.TF_CRAFT, ImmutableList.of(TF_SEARCH.get(), TF_MECHA.get(), TF_MISC.get()));
