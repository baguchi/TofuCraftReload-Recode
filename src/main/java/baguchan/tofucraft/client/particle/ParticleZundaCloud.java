    ...
    public static class CloudData implements ParticleOptions {
        public static final Deserializer<CloudData> DESERIALIZER = new Deserializer<CloudData>() {
            public CloudData fromCommand(ParticleType<CloudData> particleTypeIn, StringReader reader) throws CommandSyntaxException {
                ...
                return new CloudData(particleTypeIn, scale, duration, EnumCloudBehavior.GROW, shake);
            }

            public CloudData fromNetwork(ParticleType<CloudData> type, FriendlyByteBuf buff) {
                return new CloudData(type, buff.readFloat(), buff.readInt(), EnumCloudBehavior.GROW, buff.readFloat());
            }
        };
        ...
        public CloudData(ParticleType<CloudData> type, float scale, int duration, EnumCloudBehavior behavior, float shake) {
            this.type = type;
            this.scale = scale;
            this.behavior = behavior;
            this.shake = shake;
