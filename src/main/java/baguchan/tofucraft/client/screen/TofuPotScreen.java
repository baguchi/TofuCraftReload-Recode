...
public class TofuPotScreen extends AbstractContainerScreen<TofuPotMenu> implements RecipeUpdateListener {
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(TofuCraftReload.MODID, "textures/gui/tofu_pot.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new ImageButton(this.leftPos + 5, this.height / 2 - 19, 20, 18, 0, 0, 19, RECIPE_BUTTON_LOCATION, (p_289630_) -> {
			this.recipeBookComponent.toggleVisibility();
			this.leftPos = this.recipeBookComponent.updateScreenPosition(this.width, this.imageWidth);
			p_289630_.setPosition(this.leftPos + 5, this.height / 2 - 19);
		}));
