...
public class BitternCategory implements IRecipeCategory<BitternRecipe> {
	...
	@Override
	public @Nullable ResourceLocation getRegistryName(BitternRecipe recipe) {
		return UID;
	}
	...
	@Override
	public void draw(BitternRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
