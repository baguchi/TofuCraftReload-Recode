...
public class CraftingGenerator extends CraftingDataHelper {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		*/
		...
		makeFence(consumer, TofuBlocks.TOFUFENCE_GRILLED, TofuBlocks.GRILLEDTOFU);
		makeFence(consumer, TofuBlocks.TOFUFENCE_ZUNDA, TofuBlocks.ZUNDATOFU);
		...
		ShapedRecipeBuilder.shaped(TofuItems.SOUL_FUKUMAME.get())
				...
				.unlockedBy("has_item", has(TofuItems.SEEDS_SOYBEANS_SOUL.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(TofuItems.ZUNDA_ARROW.get(), 8)
				.pattern("###")
				.pattern("#X#")
				.pattern("###")
		...
		// kinako_bread
		ShapelessRecipeBuilder.shapeless(TofuItems.KINAKO_BREAD.get(), 3)
				.requires(TofuItems.KINAKO.get())
				.requires(Items.BREAD)
				.requires(Items.BREAD)
				.requires(Items.BREAD)
		...
		// edamame_tempura
		ShapelessRecipeBuilder.shapeless(TofuItems.EDAMAME_TEMPLA.get(), 6)
		...
		ShapelessRecipeBuilder.shapeless(TofuItems.NEGIMA.get(), 1)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(TofuItems.SOY_KARAAGE.get(), 1)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.BOTTLE_SOYOIL.get())
				.unlockedBy("has_item", has(TofuItems.SOYMEAT.get()))
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(TofuItems.SOYMEATDON.get(), 1)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.LEEK.get())
