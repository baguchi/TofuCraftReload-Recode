...
public class CraftingGenerator extends CraftingDataHelper {
	...
	protected void buildRecipes(RecipeOutput consumer) {
		...
		*/
		...
		swordItem(consumer, "tofu_solid_sword_slate", TofuItems.TOFU_SOLID_SWORD, TofuBlocks.TOFUSLATE, Tags.Items.RODS_WOODEN);
		pickaxeItem(consumer, "tofu_solid_pickaxe_slate", TofuItems.TOFU_SOLID_PICKAXE, TofuBlocks.TOFUSLATE, Tags.Items.RODS_WOODEN);
		axeItem(consumer, "tofu_solid_axe_slate", TofuItems.TOFU_SOLID_AXE, TofuBlocks.TOFUSLATE, Tags.Items.RODS_WOODEN);
		shovelItem(consumer, "tofu_solid_shovel_slate", TofuItems.TOFU_SOLID_SHOVEL, TofuBlocks.TOFUSLATE, Tags.Items.RODS_WOODEN);
		hoeItem(consumer, "tofu_solid_hoe_slate", TofuItems.TOFU_SOLID_HOE, TofuBlocks.TOFUSLATE, Tags.Items.RODS_WOODEN);
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TofuItems.TOFU_GEM_DUST.get(), 2)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, new ItemStack(TofuItems.TOFUEGG.get(), 4))
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, Optional.of(SizedFluidIngredient.of(new FluidStack(Fluids.WATER, 200))), TofuItems.YUDOFU.get(), 100, 0.1F)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, Optional.empty(), TofuItems.TOFUFRIED.get(), 100, 0.1F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, Optional.of(SizedFluidIngredient.of(new FluidStack(Fluids.WATER, 200))), TofuItems.BOTTLE_DASHI.get(), 100, 0.05F)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, TofuItems.SOYSTICK.get())
				...
				.unlockedBy("has_item", has(TofuTags.Items.SALT))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.of(SizedFluidIngredient.of(new FluidStack(Fluids.WATER, 200))), TofuItems.MISOSOUP.get(), 400, 0.1F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.MABODOFU.get(), 400, 0.6F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
				.requires(TofuItems.STARCH.get())
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.NANBAN.get(), 400, 0.6F)
				.requires(Items.COOKED_CHICKEN)
				.requires(Tags.Items.EGGS)
				.requires(Tags.Items.CROPS_WHEAT)
				.requires(Items.BOWL)
				...
				.unlockedBy("has_item", has(TofuItems.BOTTLE_SOYSAUSE.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.NANBANTOFU.get(), 400, 0.6F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
				.requires(Tags.Items.EGGS)
				.requires(Tags.Items.CROPS_WHEAT)
				.requires(Items.BOWL)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.KOYADOFUSTEW.get(), 400, 0.6F)
				.requires(TofuItems.TOFUDRIED.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TofuItems.GLASS_BOWL.get(), 2)
				.pattern("# #")
				.pattern(" # ")
				.define('#', Items.GLASS_PANE)
				.unlockedBy("has_item", has(Items.GLASS))
				.save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TofuItems.CERAMIC_BOWL.get(), 3)
				.pattern("# #")
				.pattern(" # ")
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.TASTYBEEFSTEW.get(), 400, 0.6F)
				.requires(Items.BROWN_MUSHROOM)
				...
				.unlockedBy("has_item", has(TofuItems.SALT.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.TASTYSTEW.get(), 400, 0.6F)
				.requires(Items.BROWN_MUSHROOM)
				.requires(Items.RED_MUSHROOM)
		...
		//soy beans
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TofuBlocks.SOYBEANS_SEEDS_BLOCK.get())
				.pattern("###")
				.pattern("###")
				.pattern("###")
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, TofuItems.NEGIMA.get(), 1)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.SOY_KARAAGE.get(), 300, 0.5F)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.BOTTLE_SOYOIL.get())
				.unlockedBy("has_item", has(TofuItems.SOYMEAT.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.SOYMEATDON.get(), 300, 0.5F)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.LEEK.get())
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.HELL_MABOU.get(), 400, 0.6F)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.RED_SOUP.get(), 400, 0.6F)
				.requires(TofuItems.TOFUHELL.get())
				.requires(Items.COOKED_COD)
				.requires(Items.CARROT)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, Optional.empty(), TofuItems.HELL_RED_SOUP.get(), 400, 0.6F)
				.requires(TofuItems.TOFUHELL.get())
				.requires(Items.COOKED_COD)
				.requires(Items.CARROT)
				.requires(Items.BEETROOT)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, Optional.empty(), TofuItems.STEAMED_BREAD.get(), 300, 0.5F)
				.requires(TofuTags.Items.MILK_SOYMILK)
				.requires(Tags.Items.EGGS)
				.requires(Items.SUGAR)
				.requires(Tags.Items.CROPS_WHEAT)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, Optional.empty(), TofuItems.STEAMED_BREAD_COCOA.get(), 300, 0.5F)
				.requires(TofuTags.Items.MILK_SOYMILK)
				.requires(Tags.Items.EGGS)
				.requires(Items.SUGAR)
				.requires(Tags.Items.CROPS_WHEAT)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TofuBlocks.ANTENNA_BASIC.get())
				...
				.unlockedBy("has_item", has(TofuItems.TOFUGEM.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TofuBlocks.ANTENNA_ADVANCE.get())
				.pattern("T")
				.pattern("G")
				.pattern("A")
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TofuItems.TF_BATTERY.get())
				...
				.unlockedBy("has_item", has(TofuItems.TOFUGEM.get()))
				.save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TofuItems.TF_DEVICE.get())
				.pattern("TTT")
				.pattern("LCO")
				.pattern("TTT")
				.define('O', TofuItems.TF_OSCILLATOR.get())
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, Optional.empty(), TofuItems.MONSTER_PORK_JERKY.get(), 340, 0.1F)
				...
				.unlockedBy("has_item", has(TofuItems.SALT.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, Optional.of(SizedFluidIngredient.of(Fluids.WATER, 200)), TofuItems.BOILED_EDAMAME.get(), 12, 200, 0.2F)
				.requires(TofuItems.EDAMAME.get(), 12)
				.unlockedBy("has_item", has(TofuItems.EDAMAME.get()))
				.save(consumer);

		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, Optional.empty(), TofuItems.APRICOTJERRY_BOTTLE.get(), 1, 300, 0.3F)
				.requires(TofuItems.APRICOT.get())
				.requires(Items.SUGAR)
				.requires(Items.GLASS_BOTTLE)
				.unlockedBy("has_item", has(TofuItems.APRICOT.get()))
		...
		HardenRecipeBuilder.harden(TofuBlocks.ISHITOFU.get().asItem().getDefaultInstance(), Ingredient.of(TofuBlocks.MOMENTOFU.get())).unlockedBy("has_item", has(TofuBlocks.MOMENTOFU.get())).save(consumer, prefix("harden_to_ishi"));
		HardenRecipeBuilder.harden(TofuBlocks.METALTOFU.get().asItem().getDefaultInstance(), Ingredient.of(TofuBlocks.ISHITOFU.get())).unlockedBy("has_item", has(TofuBlocks.ISHITOFU.get())).save(consumer, prefix("harden_to_metal"));
	}
}
