...
public class TofuPotShapelessRecipeBuilder implements RecipeBuilder {
	 ...
	 */
	public TofuPotShapelessRecipeBuilder requires(TagKey<Item> tag) {
	...
	public void save(RecipeOutput recipeOutput, ResourceLocation id) {
		...
		recipeOutput.accept(id, shapelessrecipe, advancement$builder.build(id.withPrefix("recipes/" + this.category.getSerializedName() + "/")));
	}
