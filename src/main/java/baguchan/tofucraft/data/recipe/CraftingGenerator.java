package baguchan.tofucraft.data.recipe;

import baguchan.tofucraft.data.recipe.builder.TFShapedRecipeBuilder;
import baguchan.tofucraft.data.recipe.builder.TFShapelessRecipeBuilder;
import baguchan.tofucraft.data.recipe.builder.TofuPotShapelessRecipeBuilder;
...
*/
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, TofuItems.TOFUEGG.get(), 4, 300, 0.1F)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, TofuItems.TOFUFRIED.get(), 100, 0.1F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
...
*/
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.MABODOFU.get(), 400, 0.6F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
				.requires(TofuItems.STARCH.get())
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.NANBAN.get(), 400, 0.6F)
				.requires(Items.COOKED_CHICKEN)
				.requires(Tags.Items.EGGS)
				.requires(Tags.Items.CROPS_WHEAT)
				.requires(Items.BOWL)
				...
				.unlockedBy("has_item", has(TofuItems.BOTTLE_SOYSAUSE.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.NANBANTOFU.get(), 400, 0.6F)
				.requires(Ingredient.of(TofuItems.TOFUKINU.get(), TofuItems.TOFUMOMEN.get()))
				.requires(Tags.Items.EGGS)
				.requires(Tags.Items.CROPS_WHEAT)
				.requires(Items.BOWL)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.KOYADOFUSTEW.get(), 400, 0.6F)
				.requires(TofuItems.TOFUDRIED.get())
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.TASTYBEEFSTEW.get(), 400, 0.6F)
				.requires(Items.BROWN_MUSHROOM)
				...
				.unlockedBy("has_item", has(TofuItems.SALT.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.TASTYSTEW.get(), 400, 0.6F)
				.requires(Items.BROWN_MUSHROOM)
				.requires(Items.RED_MUSHROOM)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, TofuItems.NEGIMA.get(), 1)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.SOY_KARAAGE.get(), 300, 0.5F)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.BOTTLE_SOYOIL.get())
				.unlockedBy("has_item", has(TofuItems.SOYMEAT.get()))
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.SOYMEATDON.get(), 300, 0.5F)
				.requires(TofuItems.SOYMEAT.get())
				.requires(TofuItems.BOTTLE_SOYSAUSE.get())
				.requires(TofuItems.LEEK.get())
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.HELL_MABOU.get(), 400, 0.6F)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.RED_SOUP.get(), 400, 0.6F)
				.requires(TofuItems.TOFUHELL.get())
				.requires(Items.COOKED_COD)
				.requires(Items.CARROT)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MEAL, TofuItems.HELL_RED_SOUP.get(), 400, 0.6F)
				.requires(TofuItems.TOFUHELL.get())
				.requires(Items.COOKED_COD)
				.requires(Items.CARROT)
				.requires(Items.BEETROOT)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, TofuItems.STEAMED_BREAD.get(), 300, 0.5F)
				.requires(TofuTags.Items.MILK_SOYMILK)
				.requires(Tags.Items.EGGS)
				.requires(Items.SUGAR)
				.requires(Tags.Items.CROPS_WHEAT)
				...
				.save(consumer);
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.MISC, TofuItems.STEAMED_BREAD_COCOA.get(), 300, 0.5F)
				.requires(TofuTags.Items.MILK_SOYMILK)
				.requires(Tags.Items.EGGS)
				.requires(Items.SUGAR)
				.requires(Tags.Items.CROPS_WHEAT)
	...
	/*	ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, TofuBlocks.TF_CRAFTER.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TofuBlocks.TF_CRAFTING_TABLE.get())
				...
				.unlockedBy("has_item", has(TofuBlocks.TF_STORAGE.get()))
				.save(consumer);
		...
		TFShapelessRecipeBuilder.shapeless(TFCraftingCategory.MISC, TofuItems.ZUNDA_INGOT.get(), 1, 400)
				...
				.unlockedBy("has_item", has(TofuItems.ZUNDAMA.get()))
				.save(consumer);
		TFShapedRecipeBuilder.shaped(TFCraftingCategory.MISC, TofuItems.ZUNDA_BOW.get(), 1, 4000)
		...
		TFShapedRecipeBuilder.shaped(TFCraftingCategory.MISC, TofuItems.TOFUSTICK.get(), 1, 4000)
		...
		TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, TofuItems.MONSTER_JERKY.get(), 340, 0.1F)
				.requires(Items.ROTTEN_FLESH)
				.requires(TofuItems.SALT.get(), 4)
				.unlockedBy("has_item", has(TofuItems.SALT.get()))
				.save(consumer);
		/*TofuPotShapelessRecipeBuilder.shapeless(TofuPotCategory.FAST_FOOD, TofuItems.MONSTER_PORK_JERKY.get(), 340, 0.1F)
