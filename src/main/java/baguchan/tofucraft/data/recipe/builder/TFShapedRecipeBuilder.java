...
public class TFShapedRecipeBuilder implements RecipeBuilder {
	...
	public static TFShapedRecipeBuilder shaped(TFCraftingCategory p_250853_, ItemLike p_249747_) {
		return shaped(p_250853_, p_249747_, 1, 500);
	}
	...
	public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
		...
		p_126141_.accept(new TFShapedRecipeBuilder.Result(p_126142_, this.result, this.count, this.group == null ? "" : this.group, this.category, this.rows, this.key, this.advancement, p_126142_.withPrefix("recipes/" + this.category.getSerializedName() + "/"), this.showNotification, this.tfNeed));
	}
	...
	public static class Result implements FinishedRecipe {
		...
		public void serializeRecipeData(JsonObject p_126167_) {
			p_126167_.addProperty("category", this.category.getSerializedName());
			...
			p_126167_.addProperty("tf", this.tfNeed);
		}
