...
public class EffectProtectionEnchantment extends Enchantment {
	public EffectProtectionEnchantment(Rarity p_i50019_1_, EquipmentSlot... p_i50019_2_) {
		super(p_i50019_1_, TofuEnchantments.TOFU_DIAMOND_ARMOR_CATEGORY, p_i50019_2_);
	}
