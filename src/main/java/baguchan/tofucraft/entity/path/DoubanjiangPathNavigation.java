...
public class DoubanjiangPathNavigation extends PathNavigation {
	private boolean allowBreaching;

	public DoubanjiangPathNavigation(Mob p_26594_, Level p_26595_) {
		super(p_26594_, p_26595_);
	}

	protected PathFinder createPathFinder(int p_26598_) {
		this.allowBreaching = this.mob.getType() == EntityType.DOLPHIN;
		this.nodeEvaluator = new DoubanjiangSwimNodeEvaluator(this.allowBreaching);
