...
public class ZundaArrowEntity extends AbstractArrowEntity {
	...
	public void func_70071_h_() {
		super.func_70071_h_();
		if (this.level.field_72995_K && !this.field_70254_i)
			this.level.func_195594_a((IParticleData) ParticleTypes.field_197590_A, func_226277_ct_(), func_226278_cu_(), func_226281_cx_(), 0.0D, 0.0D, 0.0D);
	}

	protected ItemStack func_184550_j() {
		return new ItemStack((IItemProvider) TofuItems.ZUNDA_ARROW);
	}
	...
	protected void func_213868_a(EntityRayTraceResult p_213868_1_) {
		...
		if (entity instanceof CreatureEntity && ((CreatureEntity) entity).func_70668_bt() == CreatureAttribute.field_223223_b_) {
			if (entity.func_70097_a(damagesource, i)) {
				...
				if (!this.level.field_72995_K && entity1 instanceof LivingEntity) {
				...
				playSound(SoundEvents.field_187731_t, 1.0F, 1.2F / (this.field_70146_Z.nextFloat() * 0.2F + 0.9F));
				if (func_213874_s() <= 0)
					func_70106_y();
			} else {
				...
				if (!this.level.field_72995_K && func_213322_ci().func_189985_c() < 1.0E-7D) {
	...
	protected void func_184548_a(LivingEntity p_184548_1_) {
		...
		if (!this.level.isClientSide() &&
			...
			ItemEntity itemEntity = new ItemEntity(this.level, func_226277_ct_(), func_226278_cu_(), func_226281_cx_(), new ItemStack((IItemProvider) TofuItems.TOFUZUNDA, 2));
			this.level.func_217376_c((Entity) itemEntity);
	...
	public void func_70037_a(CompoundNBT p_70037_1_) {
		...
		if (p_70037_1_.func_74764_b("Duration"))
			this.duration = p_70037_1_.func_74762_e("Duration");
	}

	public void func_213281_b(CompoundNBT p_213281_1_) {
		super.func_213281_b(p_213281_1_);
		p_213281_1_.func_74768_a("Duration", this.duration);
	}
