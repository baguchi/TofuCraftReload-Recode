...
public abstract class SoyMilkHellFluid extends WaterFluid {
	public Fluid func_210197_e() {
		return (Fluid) TofuFluids.SOYMILK_HELL_FLOW;
	}

	public Fluid func_210198_f() {
		return (Fluid) TofuFluids.SOYMILK_HELL;
	}
	...
	public BlockState func_204527_a(FluidState p_204527_1_) {
		return (BlockState) TofuBlocks.SOYMILK_HELL.func_176223_P().func_206870_a((Property) FlowingFluidBlock.field_176367_b, Integer.valueOf(func_207205_e(p_204527_1_)));
	}

	public boolean func_207187_a(Fluid p_207187_1_) {
		return (p_207187_1_ == TofuFluids.SOYMILK_HELL || p_207187_1_ == TofuFluids.SOYMILK_HELL_FLOW);
	}
	...
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("tofucraft", "block/soymilk_hell"), new ResourceLocation("tofucraft", "block/soymilk_hell_flow"))

				.overlay(new ResourceLocation("tofucraft", "block/soymilk_hell_overlay")).build((Fluid) this);
	}
