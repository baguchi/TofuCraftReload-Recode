...
public abstract class SoyMilkSoulFluid extends WaterFluid {
	public Fluid func_210197_e() {
		return (Fluid) TofuFluids.SOYMILK_SOUL_FLOW;
	}

	public Fluid func_210198_f() {
		return (Fluid) TofuFluids.SOYMILK_SOUL;
	}
	...
	public BlockState func_204527_a(FluidState p_204527_1_) {
		return (BlockState) TofuBlocks.SOYMILK_SOUL.func_176223_P().func_206870_a((Property) FlowingFluidBlock.field_176367_b, Integer.valueOf(func_207205_e(p_204527_1_)));
	}
	...
	protected FluidAttributes createAttributes() {
		return FluidAttributes.builder(new ResourceLocation("tofucraft", "block/soymilk_soul"), new ResourceLocation("tofucraft", "block/soymilk_soul_flow"))
				...
				.overlay(new ResourceLocation("tofucraft", "block/soymilk_soul_overlay")).build((Fluid) this);
	}
