...
public class TFCraftingTableMenu extends RecipeBookMenu<CraftingInput, TFCraftingRecipe> {
	...
	public boolean recipeMatches(RecipeHolder<TFCraftingRecipe> recipe) {
		return recipe.value().matches(CraftingInput.of(3, 3, blockEntity.getInventory()), level);
	}
