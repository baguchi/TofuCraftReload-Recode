...
public class SoyBallItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level p_41432_, Player p_41433_, InteractionHand p_41434_) {
		...
		p_41433_.getCooldowns().addCooldown(stack.getItem(), 60);
		return repairTofuArmor(p_41433_, stack) ? InteractionResultHolder.success(stack) : super.use(p_41432_, p_41433_, p_41434_);
	}
