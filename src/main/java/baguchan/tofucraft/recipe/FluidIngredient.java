...
public class FluidIngredient implements Predicate<FluidStack> {
	...
	private static final java.util.Set<FluidIngredient> INSTANCES = Collections.newSetFromMap(new java.util.WeakHashMap<FluidIngredient, Boolean>());
	...
	public static FluidIngredient of(TagKey<Fluid> p_43912_) {
		return fromValues(Stream.of(new TagValue(p_43912_)));
	}
