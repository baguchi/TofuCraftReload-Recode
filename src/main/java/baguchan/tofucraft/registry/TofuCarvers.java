...
public class TofuCarvers {
	public static final WorldCarver<ProbabilityConfig> TOFU_CAVE = (WorldCarver<ProbabilityConfig>) new TofuCaveCarver(ProbabilityConfig.field_236576_b_, 256);

	public static final WorldCarver<ProbabilityConfig> TOFU_CANYON = (WorldCarver<ProbabilityConfig>) new TofuCanyonCarver(ProbabilityConfig.field_236576_b_);
