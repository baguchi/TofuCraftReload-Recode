...
public class TofuEnchantments {
	...
	public static final Supplier<Enchantment> BATCH = ENCHANTMENT.register("batch", () -> new BatchEnchantment(Enchantment.definition(TofuTags.Items.TOFU_DIAMOND_MINEABLE_ENCHANTABLE, 1, 1, Enchantment.dynamicCost(20, 15), Enchantment.dynamicCost(50, 15), 4, EquipmentSlot.MAINHAND)));
