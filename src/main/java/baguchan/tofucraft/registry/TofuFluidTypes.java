...
public class TofuFluidTypes {
	...
	public static final Supplier<FluidType> SOYMILK = FLUID_TYPES.register("soymilk", () -> new SoymilkFluidType(FluidType.Properties.create().pathType(BlockPathTypes.WATER).canExtinguish(true).fallDistanceModifier(0F).motionScale(0.007F).canHydrate(true).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
