...
public class TofuFoods {
	...
	public static final FoodProperties OAGE = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.6F).fast().build();
	...
	public static final FoodProperties TOFUFRIED_POUCH = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.6F).fast().build();
	public static final FoodProperties AGEDASHI_TOFU = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F).fast().build();
	public static final FoodProperties TOFUANNIN = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).fast().build();
	public static final FoodProperties TOFUSTRAWBERRY = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).fast().build();
	...
	public static final FoodProperties SOYSTICK = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.4F).fast().effect(() -> new MobEffectInstance(TofuEffects.SOY_HEALTHY.get(), 600), 1).build();
	...
	public static final FoodProperties CHILI = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200), 1.0F).build();
	public static final FoodProperties MABODOFU = (new FoodProperties.Builder()).nutrition(8).saturationMod(0.9F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	...
	public static final FoodProperties FUKUMENI = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).build();
	...
	public static final FoodProperties NETHER_MANJU = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.35F).fast().alwaysEat().effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 400), 1.0F).build();
	public static final FoodProperties SOUL_MANJU = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.35F).fast().alwaysEat().effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 600), 1.0F).build();
	...
	public static final FoodProperties OKARASTICK = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.2F).fast().effect(() -> new MobEffectInstance(TofuEffects.SOY_HEALTHY.get(), 600), 1).build();
	...
	public static final FoodProperties APRICOT = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).build();
	...
	public static final FoodProperties HELL_MABOU = (new FoodProperties.Builder()).nutrition(6).saturationMod(0.6F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 2400), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	public static final FoodProperties RED_SOUP = (new FoodProperties.Builder()).nutrition(10).saturationMod(1.0F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1200), 1.0F).build();
	public static final FoodProperties HELL_RED_SOUP = (new FoodProperties.Builder()).nutrition(10).saturationMod(1.0F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 6000), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 3600), 1.0F).build();
	public static final FoodProperties SUKIYAKI = (new FoodProperties.Builder()).nutrition(10).saturationMod(1.0F).build();
	public static final FoodProperties TOFU_BUNS_BURGER = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.8F).build();
	public static final FoodProperties STEAMED_BREAD = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.45F).build();
	...
	public static final FoodProperties EDAMAME_TEMPLA = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F).fast().build();
