...
public class TofuFoods {
	...
	public static final FoodProperties TOFUMISO = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.6F).fast().effect(() -> new MobEffectInstance(TofuEffects.MISO_BOOST, 600, 0), 1.0F).build();
	...
	public static final FoodProperties AGEDASHI_TOFU = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.6F).usingConvertsTo(Items.BOWL).fast().build();
	...
	public static final FoodProperties MISOSOUP = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.6F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(TofuEffects.MISO_BOOST, 2400, 0), 1.0F).build();
	public static final FoodProperties MOYASHIITAME = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.55F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties MOYASHIOHITASHI = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.55F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties SALTYMELON = (new FoodProperties.Builder()).nutrition(2).saturationModifier(0.35F).build();

	public static final FoodProperties CHILI = (new FoodProperties.Builder()).nutrition(1).saturationModifier(0.1F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200), 1.0F).effect(() -> new MobEffectInstance(TofuEffects.COUGH, 600), 1.0F).build();
	public static final FoodProperties MABODOFU = (new FoodProperties.Builder()).nutrition(10).saturationModifier(0.9F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	public static final FoodProperties NANBAN = (new FoodProperties.Builder()).nutrition(9).saturationModifier(0.7F).usingConvertsTo(Items.BOWL).build();
	public static final FoodProperties NANBANTOFU = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.6F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(TofuEffects.SOY_HEALTHY, 1200, 1), 1.0F).build();

	public static final FoodProperties FUKUMENI = (new FoodProperties.Builder()).nutrition(2).saturationModifier(0.3F).build();
	public static final FoodProperties KOYADOFUSTEW = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.35F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties YAKIONIGIRI_MISO = (new FoodProperties.Builder()).nutrition(4).fast().saturationModifier(0.65F).effect(() -> new MobEffectInstance(TofuEffects.MISO_BOOST, 1200, 0), 1.0F).build();
	public static final FoodProperties YAKIONIGIRI_SHOYU = (new FoodProperties.Builder()).nutrition(4).fast().saturationModifier(0.65F).build();
	...
	public static final FoodProperties RICE_NETHER_NATTO = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.65F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1200), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	public static final FoodProperties RICE_NETHER_NATTO_LEEK = (new FoodProperties.Builder()).nutrition(5).saturationModifier(0.675F).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1200), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	...
	public static final FoodProperties GOHEIMOCHI = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.65F).usingConvertsTo(Items.STICK).effect(() -> new MobEffectInstance(TofuEffects.MISO_BOOST, 1200, 0), 1.0F).build();

	public static final FoodProperties INARI = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.8F).build();

	public static final FoodProperties OKARASTICK = (new FoodProperties.Builder()).nutrition(3).saturationModifier(0.2F).fast().effect(() -> new MobEffectInstance(TofuEffects.SOY_HEALTHY, 600), 1).build();
	public static final FoodProperties OKARA_DONUT = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.3F).build();

	public static final FoodProperties SOBOROTOFUSAUTE = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.8F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties NIKUJAGA = (new FoodProperties.Builder()).nutrition(10).saturationModifier(1.0F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties TASTYSTEW = (new FoodProperties.Builder()).nutrition(12).saturationModifier(0.90F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(TofuEffects.SOY_HEALTHY, 1200, 1), 1.0F).build();
	...
	public static final FoodProperties NATTOHIYAYAKKO = (new FoodProperties.Builder()).nutrition(4).saturationModifier(0.35F).usingConvertsTo(Items.BOWL).build();

	//Tofu delight
	public static final FoodProperties TOFU_EGG = (new FoodProperties.Builder()).nutrition(2).saturationModifier(0.32F).fast().build();
	public static final FoodProperties SOYSAUSE_RAMEN = (new FoodProperties.Builder()).nutrition(10).saturationModifier(0.85F).usingConvertsTo(Items.BOWL).build();

	public static final FoodProperties HELL_MABOU = (new FoodProperties.Builder()).nutrition(10).saturationModifier(0.8F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 2400), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200), 1.0F).build();
	public static final FoodProperties RED_SOUP = (new FoodProperties.Builder()).nutrition(12).saturationModifier(1.0F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1200), 1.0F).build();
	public static final FoodProperties HELL_RED_SOUP = (new FoodProperties.Builder()).nutrition(12).saturationModifier(1.0F).usingConvertsTo(Items.BOWL).effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 6000), 1.0F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 3600), 1.0F).build();
	public static final FoodProperties SUKIYAKI = (new FoodProperties.Builder()).nutrition(13).saturationModifier(1.0F).usingConvertsTo(Items.BOWL).build();
	...
	public static final FoodProperties NEGIMA = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.65F).usingConvertsTo(Items.STICK).build();
