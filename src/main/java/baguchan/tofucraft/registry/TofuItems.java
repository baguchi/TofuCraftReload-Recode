...
public class TofuItems {
	...
	public static final Item TOFU_SOLID_PICKAXE = new PickaxeItem(TofuItemTier.SOLID, 1, -2.7F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	...
	public static final Item TOFU_METAL_AXE = new AxeItem(TofuItemTier.METAL, 5.0F, -3.1F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	public static final Item TOFU_METAL_PICKAXE = new PickaxeItem(TofuItemTier.METAL, 1, -2.7F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	...
	public static final Item TOFU_DIAMOND_SWORD = new SwordItem(TofuItemTier.TOFUDIAMOND, 3, -2.45F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	public static final Item TOFU_DIAMOND_AXE = new AxeItem(TofuItemTier.TOFUDIAMOND, 5.0F, -3.25F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	public static final Item TOFU_DIAMOND_PICKAXE = new PickaxeItem(TofuItemTier.TOFUDIAMOND, 1, -2.85F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
	public static final Item TOFU_DIAMOND_SHOVEL = new ShovelItem(TofuItemTier.TOFUDIAMOND, 1.5F, -3.05F, (new Item.Properties()).tab(TofuItemGroup.TOFUCRAFT));
