...
public class TofuItems {
	...
	public static void registerItems(RegistryEvent.Register<Item> registry) {
		...
		register(registry, KINUSWORD, "tofu_kinu_sword");
		register(registry, KINUAXE, "tofu_kinu_axe");
		register(registry, KINUPICKAXE, "tofu_kinu_pickaxe");
		register(registry, KINUSHOVEL, "tofu_kinu_shovel");
		register(registry, MOMENSWORD, "tofu_momen_sword");
		register(registry, MOMENAXE, "tofu_momen_axe");
		register(registry, MOMENPICKAXE, "tofu_momen_pickaxe");
		register(registry, MOMENSHOVEL, "tofu_momen_shovel");
		register(registry, SOLIDSWORD, "tofu_solid_sword");
		register(registry, SOLIDAXE, "tofu_solid_axe");
		register(registry, SOLIDPICKAXE, "tofu_solid_pickaxe");
		register(registry, SOLIDSHOVEL, "tofu_solid_shovel");
		register(registry, METALSWORD, "tofu_metal_sword");
		register(registry, METALAXE, "tofu_metal_axe");
		register(registry, METALPICKAXE, "tofu_metal_pickaxe");
		register(registry, METALSHOVEL, "tofu_metal_shovel");
		register(registry, TOFUDIAMONDSWORD, "tofu_diamond_sword");
		register(registry, TOFUDIAMONDAXE, "tofu_diamond_axe");
		register(registry, TOFUDIAMONDPICKAXE, "tofu_diamond_pickaxe");
		register(registry, TOFUDIAMONDSHOVEL, "tofu_diamond_shovel");
