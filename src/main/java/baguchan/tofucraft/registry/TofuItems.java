...
public class TofuItems {
	...
	public static final RegistryObject<Item> GOHEIMOCHI = ITEMS.register("goheimochi", () -> new Item((new Item.Properties()).food(TofuFoods.GOHEIMOCHI).tab(TofuCreativeModeTab.TOFUCRAFT)));
