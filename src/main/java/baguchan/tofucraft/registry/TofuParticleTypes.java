...
public class TofuParticleTypes {
    ...
    public static void registerFactories(ParticleFactoryRegisterEvent event) {
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.TOFU_PORTAL.get(), TofuPortalParticle.Provider::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.DRIP_SOYMILK_HANG.get(), SoymilkDripParticle.SoymilkHangProvider::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.DRIP_SOYMILK_FALL.get(), SoymilkDripParticle.SoymilkFallProvider::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.SOYMILK_SPLASH.get(), SoymilkSplashParticle.Provider::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.ZUNDA_CLOUD.get(), ParticleZundaCloud.CloudFactory::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.STINK.get(), ParticleStink.StinkFactory::new);
        Minecraft.getInstance().particleEngine.register(TofuParticleTypes.SIMPLE_STINKE.get(), ParticleSimpleStink.Provider::new);
    }
}