...
public class TofuTrades {
	...
	public static final Map<Tofunian.Roles, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
		...
		p_221237_0_.put(Tofunian.Roles.TOFUSMITH, getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_PICKAXE.get(), 1, 1, 3), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
				...
				, 5, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDBOOTS.get()), 14, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDCHESTPLATE.get()), 17, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDLEGGINGS.get()), 16, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDHELMET.get()), 15, 1, 2, 25, 0.2F)})));
