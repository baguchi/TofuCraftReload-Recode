...
public class TofuTrades {
	...
	public static final Map<Tofunian.Roles, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
		...
		p_221237_0_.put(Tofunian.Roles.TOFUSMITH, getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_PICKAXE.get(), 1, 1, 3), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
				, 2, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUMETAL.get(), 8, 8, 6, 0.1F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_PICKAXE.get().getDefaultInstance(), 6, 1, 4, 10, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_SHOVEL.get().getDefaultInstance(), 6, 1, 4, 10, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_SWORD.get().getDefaultInstance(), 6, 1, 4, 10, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_AXE.get().getDefaultInstance(), 6, 1, 4, 10, 0.2F)}
				, 3, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_BOOTS.get().getDefaultInstance(), 4, 1, 4, 12, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_CHESTPLATE.get().getDefaultInstance(), 7, 1, 4, 16, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_LEGGINGS.get().getDefaultInstance(), 6, 1, 4, 15, 0.2F), new EnchantedItemsForZundaRubyTrade(TofuItems.TOFU_METAL_HELMET.get().getDefaultInstance(), 5, 1, 4, 14, 0.2F)}
