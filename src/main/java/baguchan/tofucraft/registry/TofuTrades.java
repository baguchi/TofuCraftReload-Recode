...
public class TofuTrades {
	...
	static class ZundaRubyForItemsTrade implements VillagerTrades.ITrade {
		...
		public MerchantOffer func_221182_a(Entity trader, Random rand) {
			...
			return new MerchantOffer(itemstack, new ItemStack((IItemProvider) TofuItems.ZUNDARUBY), this.maxUses, this.xpValue, this.priceMultiplier);
		}
	}
	...
	static class ItemsForZundaRubyTrade implements VillagerTrades.ITrade {
		...
		public ItemsForZundaRubyTrade(Block sellingItem, int rubyCount, int sellingItemCount, int maxUses, int xpValue) {
			this(new ItemStack((IItemProvider) sellingItem), rubyCount, sellingItemCount, maxUses, xpValue);
		}

		public ItemsForZundaRubyTrade(Item sellingItem, int rubyCount, int sellingItemCount, int xpValue) {
			this(new ItemStack((IItemProvider) sellingItem), rubyCount, sellingItemCount, 12, xpValue);
		}
		...
		public MerchantOffer func_221182_a(Entity trader, Random rand) {
			return new MerchantOffer(new ItemStack((IItemProvider) TofuItems.ZUNDARUBY, this.rubyCount), new ItemStack((IItemProvider) this.sellingItem.func_77973_b(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
		}
	}
}
