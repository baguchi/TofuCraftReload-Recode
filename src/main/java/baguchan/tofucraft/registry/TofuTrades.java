...
public class TofuTrades {
    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> TRAVELER_TOFUNIAN_TRADE = getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(Blocks.WHITE_WOOL, 8, 6, 5), new ZundaRubyForItemsTrade(Blocks.GLASS, 9, 6, 5), new ZundaRubyForItemsTrade(Items.WHEAT, 16, 6, 5), new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 6, 5)}
            , 2, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.TOFUNIAN_SOY_CHOCOLATE.get(), 1, 9, 5, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_HONEY.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUMPKIN.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUDDING.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_APPLE.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.ZUNDA.get(), 1, 6, 4, 5)}));
    ...
    public static final Map<Tofunian.Roles, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
        p_221237_0_.put(Tofunian.Roles.TOFUCOOK, getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 14, 1), new ItemsForZundaRubyTrade(TofuBlocks.ISHITOFU_BRICK.get(), 1, 12, 4, 3)}
        ...
        p_221237_0_.put(Tofunian.Roles.TOFUSMITH, getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_PICKAXE.get(), 1, 1, 3), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
                , 2, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUMETAL.get(), 8, 8, 6, 0.1F), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_PICKAXE.get(), 6, 1, 4, 10), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_SHOVEL.get(), 6, 1, 4, 10), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_SWORD.get(), 6, 1, 4, 10), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_AXE.get(), 6, 1, 4, 10)}
                , 3, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_BOOTS.get(), 4, 1, 4, 12), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_CHESTPLATE.get(), 7, 1, 4, 16), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_LEGGINGS.get(), 6, 1, 4, 15), new ItemsForZundaRubyTrade(TofuItems.TOFU_METAL_HELMET.get(), 5, 1, 4, 14)}
                , 4, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_PICKAXE.get()), 16, 1, 2, 20, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_SHOVEL.get()), 14, 1, 2, 20, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_SWORD.get()), 15, 1, 2, 20, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_AXE.get()), 16, 1, 2, 20, 0.2F)}
                , 5, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_BOOTS.get()), 14, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_CHESTPLATE.get()), 17, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_LEGGINGS.get()), 16, 1, 2, 25, 0.2F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_HELMET.get()), 15, 1, 2, 25, 0.2F)})));
    ...
    static class FairTrade implements VillagerTrades.ItemListing {
        ...
        @Nullable
        @Override
        public MerchantOffer getOffer(@NotNull Entity entity, @NotNull Random randomSource) {
