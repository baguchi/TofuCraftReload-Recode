...
public class TofuTrades {
	...
	public static final Map<Tofunian.Roles, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
		p_221237_0_.put(Tofunian.Roles.TOFUCOOK, gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 14, 1), new ItemsForZundaRubyTrade(TofuBlocks.ISHITOFU_BRICK.get(), 1, 12, 4, 3)}
				, 2, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUKINU.get(), 28, 9, 6), new ItemsForZundaRubyTrade(TofuItems.KINAKO_MANJU.get(), 1, 6, 8, 6)}
				...
				, 4, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.YUBA.get(), 18, 12, 15), new ZundaRubyForItemsTrade(TofuBlocks.LEEK_STEM.get(), 16, 8, 15), new FairTrade(TofuItems.APRICOTJERRY_BOTTLE.get(), TofuItems.APRICOT.get(), 16, 2)}
		...
		p_221237_0_.put(Tofunian.Roles.TOFUSMITH, gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_PICKAXE.get(), 1, 1, 3), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
				...
				, 4, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_PICKAXE.get()), 16, 1, 2, 20, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_SHOVEL.get()), 14, 1, 2, 20, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_SWORD.get()), 15, 1, 2, 20, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.TOFU_DIAMOND_AXE.get()), 16, 1, 2, 20, 0.1F)}
				, 5, new VillagerTrades.ItemListing[]{new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDBOOTS.get()), 14, 1, 2, 25, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDCHESTPLATE.get()), 18, 1, 2, 25, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDLEGGINGS.get()), 16, 1, 2, 25, 0.1F), new EnchantedItemsForZundaRubyTrade(new ItemStack(TofuItems.ARMOR_TOFU_DIAMONDHELMET.get()), 15, 1, 2, 25, 0.1F)})));
