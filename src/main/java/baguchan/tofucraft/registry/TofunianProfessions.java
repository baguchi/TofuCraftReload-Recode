...
public class TofunianProfessions {
	public static final ResourceKey<Registry<TofunianProfession>> TOFUNIAN_PROFESSION_REGISTRY_KEY = createRegistryKey(ResourceLocation.fromNamespaceAndPath(TofuCraftReload.MODID, "tofunian_profession"));
	...
	public static final Registry<TofunianProfession> TOFUNIAN_PROFESSION_REGISTRY = new RegistryBuilder<>(TOFUNIAN_PROFESSION_REGISTRY_KEY)
			...
			.defaultKey(ResourceLocation.fromNamespaceAndPath(TofuCraftReload.MODID, "none"))
