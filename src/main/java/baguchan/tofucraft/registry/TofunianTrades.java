...
public class TofunianTrades {
	...
	public static final Map<ResourceKey<TofunianProfession>, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
		p_221237_0_.put(TofunianProfessions.FARMER.getKey(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 14, 1), new ItemsForZundaRubyTrade(TofuItems.TOFUGRILLED.get(), 1, 9, 4, 3)}
		...
		p_221237_0_.put(TofunianProfessions.SMITH.getKey(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
		...
		p_221237_0_.put(TofunianProfessions.SOY_WORKER.getKey(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(Blocks.GLASS, 10, 6, 2), new ZundaRubyForItemsTrade(TofuItems.LEEK.get(), 26, 6, 2)}
		...
		p_221237_0_.put(TofunianProfessions.ENGINEER.getKey(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUGEM.get(), 10, 16, 3, 0.05F), new ItemsForZundaRubyTrade(TofuItems.TF_CIRCUIT.get(), 1, 6, 2), new ItemsForZundaRubyTrade(TofuItems.TF_COIL.get(), 1, 6, 2)}
