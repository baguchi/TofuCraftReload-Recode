...
public class JigsawHelper {
	...
	public static void registerJigsaw(MinecraftServer server, ResourceLocation poolLocation, ResourceLocation nbtLocation, int weight) {
		...
		Registry<StructureTemplatePool> templatePoolRegistry = manager.registry(Registry.TEMPLATE_POOL_REGISTRY).orElseThrow();
		Registry<StructureProcessorList> processorListRegistry = manager.registry(Registry.PROCESSOR_LIST_REGISTRY).orElseThrow();
