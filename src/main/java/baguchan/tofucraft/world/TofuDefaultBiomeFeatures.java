...
public class TofuDefaultBiomeFeatures {
	...
	public static final ConfiguredFeature<?, ?> NETHER_SOYBEAN = register("tofucraft:nether_soybean", (Feature.RANDOM_PATCH.configured(NETHER_SOYBEAN_CLUSTER).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).range(128)).chance(1));
	public static final ConfiguredFeature<?, ?> NETHER_SOYBEAN_PATCH = register("tofucraft:nether_soybean_patch", (Feature.RANDOM_PATCH.configured(NETHER_SOYBEAN_CLUSTER).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).range(86)).chance(3));
	public static final ConfiguredFeature<?, ?> SOUL_SOYBEAN = register("tofucraft:soul_soybean", (Feature.RANDOM_PATCH.configured(SOUL_SOYBEAN_CLUSTER).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).range(128)).chance(2));
	public static final ConfiguredFeature<?, ?> TOFU_FLOWER = register("tofucraft:tofu_flower", Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(PlainFlowerBlockStateProvider.INSTANCE, SimpleBlockPlacer.INSTANCE)).tries(64).build()));
