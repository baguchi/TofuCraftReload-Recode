...
public class TofuBiomeDefaultFeatures {
	public static void addDefaultCarvers(BiomeGenerationSettings.Builder p_194721_) {
		p_194721_.addCarver(GenerationStep.Carving.AIR, TofuConfiguredWorldCarvers.TOFU_CAVE);
		p_194721_.addCarver(GenerationStep.Carving.AIR, TofuConfiguredWorldCarvers.TOFU_CAVE_EXTRA_UNDERGROUND);
		p_194721_.addCarver(GenerationStep.Carving.AIR, TofuConfiguredWorldCarvers.TOFU_CANYON);
	}
