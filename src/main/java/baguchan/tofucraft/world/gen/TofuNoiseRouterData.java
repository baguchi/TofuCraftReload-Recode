...
public class TofuNoiseRouterData {
	...
	private static DensityFunction underground(HolderGetter<DensityFunction> p_224472_, HolderGetter<NormalNoise.NoiseParameters> p_256005_, DensityFunction p_224473_) {
		...
		DensityFunction densityfunction2 = DensityFunctions.noise(p_256005_.getOrThrow(Noises.CAVE_LAYER), 8.0D);
		DensityFunction densityfunction3 = DensityFunctions.mul(DensityFunctions.constant(4.0D), densityfunction2.square());
		DensityFunction densityfunction4 = DensityFunctions.noise(p_256005_.getOrThrow(Noises.CAVE_CHEESE), 0.6666666666666666D);
	...
	public static NoiseRouter tofuworld(HolderGetter<DensityFunction> p_224486_, HolderGetter<NormalNoise.NoiseParameters> p_256005_, boolean p_224487_, boolean p_224488_) {
		...
		DensityFunction densityfunction6 = DensityFunctions.shiftedNoise2d(densityfunction4, densityfunction5, 0.25D, p_256005_.getOrThrow(p_224487_ ? Noises.TEMPERATURE_LARGE : Noises.TEMPERATURE));
		DensityFunction densityfunction7 = DensityFunctions.shiftedNoise2d(densityfunction4, densityfunction5, 0.25D, p_256005_.getOrThrow(p_224487_ ? Noises.VEGETATION_LARGE : Noises.VEGETATION));
		...
		DensityFunction densityfunction13 = DensityFunctions.rangeChoice(densityfunction11, -1000000.0D, 1.5625D, densityfunction12, underground(p_224486_, p_256005_, densityfunction11));
