...
public class TofuWorldPlacements {
	...
	public static void bootstrap(BootstapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, ORE_TOFUGEM_LARGE, configuredFeature.getOrThrow(TofuWorldFeatures.ORE_TOFUGEM_LARGE), commonOrePlacement(15, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.aboveBottom(64))));
