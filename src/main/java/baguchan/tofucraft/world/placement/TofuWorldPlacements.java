...
public class TofuWorldPlacements {
	...
	public static final PlacedFeature ORE_TOFU_DIAMOND_LARGE = register("tofucraft:ore_tofu_diamond_large", TofuWorldFeatures.ORE_DIAMOND_LARGE.placed(rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))));
