...
public record TofuLearning(Optional<Identifier> learning_advancement) {
	public static final ResourceKey<Registry<TofuLearning>> REGISTRY_KEY = ResourceKey
			.createRegistryKey(Identifier.fromNamespaceAndPath(TofuCraftReload.MODID, "learning"));

	public static final Codec<TofuLearning> CODEC = RecordCodecBuilder.create(instance -> instance
			.group(
					Identifier.CODEC.optionalFieldOf("learning_advancement").forGetter(TofuLearning::learning_advancement))
	...
	public Optional<Identifier> getLearningAdvancement() {
