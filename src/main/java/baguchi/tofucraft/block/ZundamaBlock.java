...
public class ZundamaBlock extends HalfTransparentBlock {
	...
	protected static final VoxelShape SHAPE = Block.box(1.0D, 0.0D, 1.0D, 15.0D, 15.5D, 15.0D);

	public ZundamaBlock(BlockBehaviour.Properties p_53985_) {
		super(p_53985_);
	}
