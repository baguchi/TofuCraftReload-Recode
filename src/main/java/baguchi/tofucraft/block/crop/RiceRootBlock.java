...
public class RiceRootBlock extends BushBlock implements BonemealableBlock {
	...
	@Override
	public boolean isValidBonemealTarget(LevelReader p_256559_, BlockPos p_50898_, BlockState p_50899_, BonemealSource bonemealSource) {
		return p_256559_.getBlockState(p_50898_.above()).isAir();
	}

	@Override
	public boolean isBonemealSuccess(Level p_220878_, RandomSource p_220879_, BlockPos p_220880_, BlockState p_220881_, BonemealSource bonemealSource) {
		return true;
	}

	@Override
	public void performBonemeal(ServerLevel p_220874_, RandomSource p_220875_, BlockPos p_220876_, BlockState p_220877_, BonemealSource bonemealSource) {
