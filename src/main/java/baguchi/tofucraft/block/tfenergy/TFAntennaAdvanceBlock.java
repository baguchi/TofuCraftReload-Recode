...
import baguchi.tofucraft.api.tfenergy.IAnntena;
...
public class TFAntennaAdvanceBlock extends Block implements IAnntena {
	private static final VoxelShape SHAPE = Block.box(5.0, 0.0, 5.0, 11.0, 16.0, 11.0);


	public TFAntennaAdvanceBlock(Properties properties) {
		super(properties);
	}
