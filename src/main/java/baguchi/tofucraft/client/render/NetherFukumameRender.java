...
public class NetherFukumameRender extends AbstractSoybeanRender<NetherFukumameEntity, ArrowRenderState> {
	public static final Identifier FUKUMAME_LOCATION = Identifier.fromNamespaceAndPath(TofuCraftReload.MODID, "textures/entity/projectiles/nether_fukumame.png");
