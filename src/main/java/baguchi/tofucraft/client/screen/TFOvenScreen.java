...
public class TFOvenScreen extends AbstractRecipeBookScreen<TFOvenMenu> implements RecipeUpdateListener {
	...
	private static final Identifier texture = Identifier.fromNamespaceAndPath(TofuCraftReload.MODID, "textures/gui/tf_oven.png");
	private boolean widthTooNarrow;

	public TFOvenScreen(
			baguchi.tofucraft.inventory.TFOvenMenu p_97825_,
			Inventory p_97827_,
			Component p_97828_
	) {
