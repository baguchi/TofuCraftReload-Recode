...
import baguchi.tofucraft.data.generator.tags.TofuDamageTypeTags;
import baguchi.tofucraft.data.generator.tags.TofuEnchantTags;
import baguchi.tofucraft.data.generator.tags.TofuEntityTags;
import baguchi.tofucraft.data.generator.tags.TofuFluidTags;
...
public class DataGenerators {
	...
	public static void gatherData(GatherDataEvent.Client event) {
		...
		generator.addProvider(true, new TofuItemTags(packOutput, lookupProvider));
		...
		generator.addProvider(true, new TofuFluidTags(packOutput, lookupProvider));
