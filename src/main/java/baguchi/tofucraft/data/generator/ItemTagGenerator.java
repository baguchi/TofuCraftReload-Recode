...
public class ItemTagGenerator extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider p_256380_) {
		...
		this.tag(ItemTags.STONE_CRAFTING_MATERIALS).add(TofuBlocks.TOFUSLATE.get().asItem()).add(TofuBlocks.TOFU_TERRAIN_ISHI.get().asItem());
		...
		this.tag(ItemTags.WOLF_FOOD).add(TofuItems.MONSTER_JERKY.get()).add(TofuItems.MONSTER_PORK_JERKY.get());
