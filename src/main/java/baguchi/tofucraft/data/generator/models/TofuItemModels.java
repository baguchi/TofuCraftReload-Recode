...
public class TofuItemModels extends ItemModelGenerators {
	...
	public void run() {
		...
		this.generateFlatItem(TofuItems.SOYMILK_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_ANNIN_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_APPLE_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_COCOA_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_FRUITS_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_HONEY_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_KINAKO_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_PUDDING_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_PUMPKIN_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_RAMUNE_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_SAKURA_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_STRAWBERRY_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		this.generateFlatItem(TofuItems.SOYMILK_TEA_BOTTLE.get(), ModelTemplates.FLAT_ITEM);
		...
		this.generateFlatItem(TofuItems.TF_DEVICE.get(), ModelTemplates.FLAT_ITEM);
		...
		this.generateDynamicTrimmableItem(TofuItems.TOFU_KINU_HELMET.get(), TRIM_PREFIX_HELMET);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_KINU_CHESTPLATE.get(), TRIM_PREFIX_CHESTPLATE);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_KINU_LEGGINGS.get(), TRIM_PREFIX_LEGGINGS);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_KINU_BOOTS.get(), TRIM_PREFIX_BOOTS);

		this.generateDynamicTrimmableItem(TofuItems.TOFU_MOMEN_HELMET.get(), TRIM_PREFIX_HELMET);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_MOMEN_CHESTPLATE.get(), TRIM_PREFIX_CHESTPLATE);
		...
		this.generateDynamicTrimmableItem(TofuItems.TOFU_METAL_LEGGINGS.get(), TRIM_PREFIX_LEGGINGS);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_METAL_BOOTS.get(), TRIM_PREFIX_BOOTS);

		this.generateDynamicTrimmableItem(TofuItems.TOFU_DIAMOND_HELMET.get(), TRIM_PREFIX_HELMET);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_DIAMOND_CHESTPLATE.get(), TRIM_PREFIX_CHESTPLATE);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_DIAMOND_LEGGINGS.get(), TRIM_PREFIX_LEGGINGS);
		this.generateDynamicTrimmableItem(TofuItems.TOFU_DIAMOND_BOOTS.get(), TRIM_PREFIX_BOOTS);
