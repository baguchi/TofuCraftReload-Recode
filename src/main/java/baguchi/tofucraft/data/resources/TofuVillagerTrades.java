...
public class TofuVillagerTrades {
	...
	public static void bootstrap(BootstrapContext<VillagerTrade> context) {
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.SEEDS_SOYBEANS.get(), 24), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_1_LEEK_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.LEEK.get(), 32), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_1_ZUNDA_RUBY_GRILLED_TOFU,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.TOFU_GRILLED, 9), 16, 2, 0.05F).build()
		);

		register(
				context,
				TOFUNIAN_FARMER_2_KINAKO_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.KINAKO.get(), 16), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_2_SALT_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.SALT.get(), 24), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_2_ZUNDA_RUBY_TOFU_COOKIE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.TOFUCOOKIE, 14), 16, 6, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_3_NATTO_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.NATTO.get(), 12), new ItemStackTemplate(TofuItems.ZUNDARUBY), 8, 10, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_3_MISO_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.MISO.get(), 12), new ItemStackTemplate(TofuItems.ZUNDARUBY), 8, 10, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_3_ZUNDA_RUBY_MISO_SOUP,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.MISOSOUP, 2), 8, 12, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_4_ZUNDA_RUBY_STRAWBERRY_TOFU,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.TOFU_STRAWBERRY, 12), 8, 15, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_4_ZUNDA_RUBY_SESAME_TOFU,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.TOFU_SESAME, 12), 8, 15, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_FARMER_5_ZUNDA_RUBY_TOFU_CAKE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuBlocks.TOFU_CAKE.asItem()), 3, 20, 0.1F).build()
		);

		register(
				context,
				TOFUNIAN_SMITH_1_TOFU_ISHI_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.TOFU_ISHI.get(), 32), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 2, 0.05F).build()
		);
		register(
				context,
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.TOFU_METAL.get(), 18), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 6, 0.05F).build()
		);
		register(
				context,
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 14), new ItemStackTemplate(TofuItems.TOFU_UPGRADE_SMITHING_TEMPLATE), 4, 22
						, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SMITH_5_ZUNDA_RUBY_ZUNDA_ARROW,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.ZUNDA_ARROW, 16), 12, 22
						, 0.1F).build()
		);
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.SOYMILK_BOTTLE, 3), 12, 2, 0.05F).build()
		);

		register(
				context,
				TOFUNIAN_SOY_WORKER_2_BOTTLE_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(Items.GLASS_BOTTLE, 8), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_2_ZUNDA_RUBY_SOY_SAUCE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.BOTTLE_SOYSAUSE, 5), 12, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_2_ZUNDA_RUBY_YUDOFU,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.YUDOFU, 3), 12, 6, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_3_ZUNDA_RUBY_SOYMILK_COCOA,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.SOYMILK_COCOA_BOTTLE, 3), 8, 10, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_4_ZUNDA_RUBY_SOYMILK_PUDDING,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.SOYMILK_PUDDING_BOTTLE, 3), 8, 10, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_3_ZUNDA_RUBY_SOYMILK_PUMPKIN,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.SOYMILK_PUMPKIN_BOTTLE, 3), 8, 10, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_3_ZUNDA_RUBY_SOYMILK_HONEY,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.SOYMILK_HONEY_BOTTLE, 3), 8, 10, 0.1F).build()
		);

		register(
				context,
				TOFUNIAN_SOY_WORKER_4_ZUNDA_RUBY_SOYMILK_RAMUNE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.SOYMILK_RAMUNE_BOTTLE, 3), 8, 15, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_5_ZUNDA_RUBY_SOYMILK_STRAWBERRY,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.SOYMILK_STRAWBERRY_BOTTLE, 5), 6, 20, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_SOY_WORKER_5_ZUNDA_RUBY_SOYMILK_TEA,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.SOYMILK_TEA_BOTTLE, 5), 6, 20, 0.1F).build()
		);
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.TOFUGEM.get(), 10), new ItemStackTemplate(TofuItems.ZUNDARUBY), 16, 3, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_1_ZUNDA_RUBY_CIRCUIT,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.TF_CIRCUIT, 6), 12, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_1_ZUNDA_RUBY_COIL,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.TF_COIL, 6), 12, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_2_TOFU_METAL_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.TOFU_METAL.get(), 12), new ItemStackTemplate(TofuItems.ZUNDARUBY), 12, 6, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_2_ZUNDA_RUBY_CAPACITOR,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 1), new ItemStackTemplate(TofuItems.TF_CAPACITOR, 4), 12, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_2_ZUNDA_RUBY_OSCILLATOR,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.TF_OSCILLATOR, 7), 12, 5, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_3_ADVANCE_TOFU_GEM_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.ADVANCE_TOFUGEM.get(), 8), new ItemStackTemplate(TofuItems.ZUNDARUBY, 2), 12, 12, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_3_ZUNDA_RUBY_BATTERY,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 2), new ItemStackTemplate(TofuItems.TF_BATTERY, 1), 6, 11, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_4_ZUNDA_RUBY_TOFU_CORE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 3), new ItemStackTemplate(TofuItems.TOFU_CORE, 1), 6, 16, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_4_ZUNDA_RUBY_TOFU_DEVICE,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 5), new ItemStackTemplate(TofuItems.TF_DEVICE, 1), 6, 17, 0.1F).build()
		);
		register(
				context,
				TOFUNIAN_ENGINEER_5_ZUNDA_RUBY_ANTENNA,
				VillagerTrade.builder(new TradeCost(TofuItems.ZUNDARUBY.get(), 6), new ItemStackTemplate(TofuBlocks.ANTENNA_BASIC.asItem(), 1), 6, 16, 0.1F).build()
		);
		...
		register(
				...
				VillagerTrade.builder(new TradeCost(TofuItems.SEEDS_SOYBEANS.get(), 24), new ItemStackTemplate(TofuItems.ZUNDARUBY), 6, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_TREAVELER_SOYMILK_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.SOYMILK_BOTTLE.get(), 3), new ItemStackTemplate(TofuItems.ZUNDARUBY), 4, 2, 0.05F).build()
		);
		register(
				context,
				TOFUNIAN_TREAVELER_EDAMAME_ZUNDA_RUBY,
				VillagerTrade.builder(new TradeCost(TofuItems.EDAMAME.get(), 24), new ItemStackTemplate(TofuItems.ZUNDARUBY), 4, 2, 0.05F).build()
		);

		register(
				context,
				TOFU_CRAFTSMAN_1_SOYBEAN_EMERALD,
				VillagerTrade.builder(new TradeCost(TofuItems.SEEDS_SOYBEANS.get(), 16), new ItemStackTemplate(Items.EMERALD, 1), 12, 2, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_1_EMERALD_SOYMILK,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(TofuItems.SOYMILK_BOTTLE, 3), 12, 2, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_1_EMERALD_GRILLED,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(TofuItems.TOFU_GRILLED, 9), 12, 2, 0.05F).build()
		);

		register(
				context,
				TOFU_CRAFTSMAN_2_BOTTLE_EMERALD,
				VillagerTrade.builder(new TradeCost(Items.GLASS_BOTTLE, 8), new ItemStackTemplate(Items.EMERALD, 1), 12, 6, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_2_EMERALD_SOY_OIL,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.BOTTLE_SOYOIL, 7), 12, 6, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_2_EMERALD_SOY_SAUCE,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.BOTTLE_SOYSAUSE, 6), 8, 7, 0.05F).build()
		);

		register(
				context,
				TOFU_CRAFTSMAN_3_SALT_EMERALD,
				VillagerTrade.builder(new TradeCost(TofuItems.SALT.get(), 14), new ItemStackTemplate(Items.EMERALD, 1), 12, 11, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_3_EMERALD_AGEDASHI_TOFU,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.AGEDASHI_TOFU, 6), 8, 12, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_3_EMERALD_OAGE,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.OAGE, 6), 8, 12, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_3_EMERALD_FRIED_TOFU,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.TOFU_FRIED, 8), 8, 12, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_3_EMERALD_FRIED_POUCH,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.TOFU_FRIED_POUCH, 8), 8, 12, 0.05F).build()
		);

		register(
				context,
				TOFU_CRAFTSMAN_4_EMERALD_MORIJIO,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 15), new ItemStackTemplate(TofuBlocks.MORIJIO.asItem(), 2), 8, 17, 0.1F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_4_EMERALD_OKARA_DONUT,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.OKARA_DONUT, 6), 8, 16, 0.05F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_5_EMERALD_MISO_SOUP,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.MISOSOUP, 3), 6, 20, 0.1F).build()
		);
		register(
				context,
				TOFU_CRAFTSMAN_5_EMERALD_MOYASHI_ITAME,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.MOYASHIITAME, 3), 6, 20, 0.1F).build()
		);

		register(
				context,
				FARMER_4_EMERALD_BOTTLE_MIRIN,
				VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(TofuItems.BOTTLE_MIRIN, 6), 8, 15, 0.1F).build()
		);
		register(
				context,
