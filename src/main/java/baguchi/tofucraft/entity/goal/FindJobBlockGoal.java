...
public class FindJobBlockGoal extends MoveToBlockGoal {
	...
	public boolean canContinueToUse() {
		return !this.findBlock && (super.canContinueToUse() && this.creature.level().isBrightOutside() && !this.creature.isBaby() && (this.creature.getRole().is(TofunianProfessions.NONE) || this.creature.getTofunianJobBlock() == null) && this.mob != null);
	}
