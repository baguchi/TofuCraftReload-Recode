...
public class TFTofuMakerResultSlot extends Slot {
	private final Player player;
	private int removeCount;

	public TFTofuMakerResultSlot(Player p_39542_, Container p_39543_, int p_39544_, int p_39545_, int p_39546_) {
	...
	protected void checkTakeAchievements(ItemStack p_39558_) {
		...
		if (playerx instanceof ServerPlayer serverplayer) {
			...
			if (container instanceof TFTofuMakerBlockEntity tfTofuMakerBlockEntity) {
				tfTofuMakerBlockEntity.awardUsedRecipesAndPopExperience(serverplayer);
			}
		}
