	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TOFU_BUILDING_BLOCKS = CREATIVE_MODE_TABS.register("tofu_building_blocks", () -> CreativeModeTab.builder()
			...
			.displayItems((parameters, output) -> {
				output.acceptAll(Stream.of(
						...
						TofuBlocks.TOFUSTAIR_MISO,
						TofuBlocks.TOFUFENCE_MISO,
						TofuBlocks.TOFUDOOR_MISO,
						TofuBlocks.TOFUTRAPDOOR_MISO,
						TofuBlocks.EGGTOFU,
						TofuBlocks.TOFUSLAB_EGG,
						TofuBlocks.TOFUSTAIR_EGG,
						TofuBlocks.TOFUFENCE_EGG,
						TofuBlocks.TOFUDOOR_EGG,
						TofuBlocks.TOFUTRAPDOOR_EGG,
						...
						TofuBlocks.TOFUFENCE_SESAME,
						TofuBlocks.TOFUDOOR_SESAME,
						TofuBlocks.TOFUTRAPDOOR_SESAME,
						...
						TofuBlocks.TOFUFENCE_DRIED,
						TofuBlocks.TOFUDOOR_DRIED,
						TofuBlocks.TOFUTRAPDOOR_DRIED,
						TofuBlocks.DRIEDTOFU_BRICK,
						TofuBlocks.TOFUSLAB_DRIEDBRICK,
						TofuBlocks.TOFUSTAIR_DRIEDBRICK,
						...
						TofuBlocks.TOFUSLAB_HELLBRICK,
						TofuBlocks.TOFUSTAIR_HELLBRICK,
