...
public class TofuEntityDatas {
	...
	public static final DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<Holder<TofunianProfession>>> TOFUNIAN_PROFESSION = ENTITY_DATAS.register("tofunian_profession", () -> EntityDataSerializer.forValueType(ByteBufCodecs.holderRegistry(TofunianProfessions.TOFUNIAN_PROFESSION_REGISTRY_KEY)));
