...
public class TofuLootTables {
	...
	public static final ResourceKey<LootTable> TOFU_VAULT_REWARD = ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(TofuCraftReload.MODID, "chests/tofu_castle/tofu_vault"));
}
