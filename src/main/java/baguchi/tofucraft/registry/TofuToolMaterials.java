...
public interface TofuToolMaterials {
	ToolMaterial KINU = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 1, 0.1F, 0.0F, 2, TofuTags.Items.TOFU_TOOL_MATERIAL);
	ToolMaterial MOMEN = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 1, 0.25F, 0.25F, 5, TofuTags.Items.TOFU_TOOL_MATERIAL);
