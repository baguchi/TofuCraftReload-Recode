...
public class TofunianTrades {
	public static final Int2ObjectMap<VillagerTrades.ItemListing[]> TRAVELER_TOFUNIAN_TRADE = getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(Blocks.WHITE_WOOL, 8, 4, 5), new ZundaRubyForItemsTrade(Blocks.GLASS, 9, 4, 5), new ZundaRubyForItemsTrade(Items.WHEAT, 16, 3, 5), new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 4, 5)
			...
			, 2, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.TOFUNIAN_SOY_CHOCOLATE.get(), 1, 9, 5, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_HONEY_BOTTLE.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUMPKIN_BOTTLE.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUDDING_BOTTLE.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_APPLE_BOTTLE.get(), 1, 3, 6, 5), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_BOTTLE.get(), 1, 3, 6, 5)
					, new ItemsForZundaRubyTrade(TofuItems.ZUNDA.get(), 1, 6, 4, 5), new ItemsForZundaRubyTrade(TofuItems.ZUNDA_ARROW.get(), 1, 8, 8, 5)
					, new ItemsForZundaRubyTrade(TofuItems.BOTTLE_SOYOIL.get(), 1, 5, 2, 5)
					, new ItemsForZundaRubyTrade(TofuItems.BOTTLE_SOYSAUSE.get(), 1, 3, 3, 5)}));

	public static final Map<TofunianProfession, Int2ObjectMap<VillagerTrades.ItemListing[]>> TOFUNIAN_TRADE = Util.make(Maps.newHashMap(), p_221237_0_ -> {
		p_221237_0_.put(TofunianProfessions.FARMER.get(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.SEEDS_SOYBEANS.get(), 16, 14, 1), new ItemsForZundaRubyTrade(TofuItems.TOFUGRILLED.get(), 1, 9, 4, 3)}
		...
		p_221237_0_.put(TofunianProfessions.SMITH.get(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUISHI.get(), 16, 10, 2), new ItemsForZundaRubyTrade(TofuItems.TOFU_SOLID_SHOVEL.get(), 1, 1, 3)}
		...
		p_221237_0_.put(TofunianProfessions.SOY_WORKER.get(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(Blocks.GLASS, 10, 6, 2), new ZundaRubyForItemsTrade(TofuItems.LEEK.get(), 26, 6, 2)}
				...
				, 4, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.SOYMILK_BOTTLE.get(), 1, 3, 6, 20), new ItemsForZundaRubyTrade(TofuItems.TOFUNIAN_SOY_CHOCOLATE.get(), 1, 6, 8, 20)}
				, 5, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.SOYMILK_ANNIN_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_APPLE_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_FRUITS_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_HONEY_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_KINAKO_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUMPKIN_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_RAMUNE_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_SAKURA_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_PUDDING_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_STRAWBERRY_BOTTLE.get(), 1, 3, 6, 30), new ItemsForZundaRubyTrade(TofuItems.SOYMILK_TEA_BOTTLE.get(), 1, 3, 6, 30)})));
		p_221237_0_.put(TofunianProfessions.ENGINEER.get(), getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUGEM.get(), 10, 16, 3, 0.05F), new ItemsForZundaRubyTrade(TofuItems.TF_CIRCUIT.get(), 1, 6, 2), new ItemsForZundaRubyTrade(TofuItems.TF_COIL.get(), 1, 6, 2)}
				, 2, new VillagerTrades.ItemListing[]{new ZundaRubyForItemsTrade(TofuItems.TOFUMETAL.get(), 12, 12, 6, 0.05F), new ItemsForZundaRubyTrade(TofuItems.TF_CAPACITOR.get(), 1, 4, 5), new ItemsForZundaRubyTrade(TofuItems.TF_OSCILLATOR.get(), 2, 7, 5)}
				, 3, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.TF_BATTERY.get(), 2, 1, 11), new ZundaRubyForItemsTrade(TofuItems.ADVANCE_TOFUGEM.get(), 4, 12, 12)}
				, 4, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuItems.TOFU_CORE.get().getDefaultInstance(), 3, 1, 6, 16, 0.1F), new ItemsForZundaRubyTrade(TofuItems.TF_DEVICE.get().getDefaultInstance(), 5, 1, 6, 17, 0.1F)}
				, 5, new VillagerTrades.ItemListing[]{new ItemsForZundaRubyTrade(TofuBlocks.ANTENNA_BASIC.toStack(), 6, 1, 6, 16, 0.1F)})));
	});
