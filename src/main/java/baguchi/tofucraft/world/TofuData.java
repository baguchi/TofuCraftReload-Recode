...
public class TofuData extends SavedData {
	public static final Codec<TofuData> CODEC = RecordCodecBuilder.create(
			p_400930_ -> p_400930_.group(
							...
							BoundingBox.CODEC.listOf().fieldOf("beated_bounding_box").xmap(ArrayList::new, Function.identity()).forGetter(p_400933_ -> (ArrayList<BoundingBox>) p_400933_.beatenDungeons)
					)
